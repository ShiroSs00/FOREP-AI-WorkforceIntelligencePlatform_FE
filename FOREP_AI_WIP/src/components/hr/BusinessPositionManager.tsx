...
export function BusinessPositionManager({ readOnly = false }: { readOnly?: boolean }) {
  ...
  return <>
    <PageHeader eyebrow="DỮ LIỆU NHÂN SỰ" title="Vị trí nghiệp vụ" description={readOnly ? "Danh mục vị trí và nhóm quyền trong workspace. Chỉ HR có quyền thay đổi." : "Quản lý chức danh nghiệp vụ và nhóm quyền dùng để backend xác định system role."} />
